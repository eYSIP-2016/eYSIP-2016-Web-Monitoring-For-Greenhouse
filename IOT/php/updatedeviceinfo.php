...
if($longitude==null || $latitude==null)
  $query2="UPDATE devices SET devices.name='$name',devices.description='$description',devices.groupId='$groupId',devices.elevation='$elevation', devices.status=0 WHERE devices.deviceId='5c:cf:7f:d1:ae:cc'";
else
